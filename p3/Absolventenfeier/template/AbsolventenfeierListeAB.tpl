                ...
                %  for key_s in data_o:
                    %if int(key_s) != 0:
                        <tr>
                            ...
                            <td><a href="/applyAbsolvent/?user=${vars}&absolventenfeier=${key_s}" class="btn btn-green">anmelden</a>&nbsp;<a href="/deleteSignInAbsolvent/${vars}" class="clDelete">abmelden</a></td>
                        </tr>
                    %endif
                % endfor
            </table>
            <a href="/editAbsolvent/${vars}" class="btn">bearbeiten</a>
        </div>
    </body>
</html>